...
const translations = {
    it: {
        ...
        'mainDemo.guide.summaryDescription': 'Guida rapida a editing, validazione, lookup e salvataggio',
        'mainDemo.guide.open': 'Apri guida',
        'mainDemo.guide.close': 'Chiudi guida',
    ...
    en: {
        ...
        'mainDemo.guide.summaryDescription': 'Quick guide to editing, validation, lookup and saving',
        'mainDemo.guide.open': 'Open guide',
        'mainDemo.guide.close': 'Close guide',
