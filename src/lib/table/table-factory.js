 ...
 * table build and data reloads. When lookup description floating messages are
 * enabled, lookup cells are marked on render so hover descriptions can work
 * before a cell is edited.
 *
...
export function createTable(options = {}) {
    ...
    controller = {
         ...
         *
         * Row components expose advanced operations. Mutating rows directly
         * through those components may bypass or interfere with AMB Grid CRUD
         * tracking.
         *
         * @param {...any} args - Optional arguments used to select the row range.
         ...
         *
         * The returned component exposes advanced row operations. Mutating the
         * row directly through that component may bypass or interfere with AMB
         * Grid CRUD tracking.
         *
