...
export const createCrudMethods = ({ crud }) => ({
     ...
     *
     * `canSave` reports whether the changes are savable under `savePolicy`, not
     * whether the complete grid is free of errors. `isPartialSave` identifies
     * a mixed valid/invalid `valid-only` candidate; it does not perform a save.
     *
     * @param {SavePayloadOptions} [options]
     *   Save payload options forwarded unchanged.
     * @returns {SavePayload}
     *   Save payload generated by the current CRUD layer.
     */
