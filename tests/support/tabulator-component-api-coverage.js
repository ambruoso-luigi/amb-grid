...
export const COMPONENT_API_COVERAGE = [
    ...
    { component: 'range', method: 'setStartBound', status: 'exposed', classification: 'overridden', publicMethod: 'setRangeStartBound', controller: 'range-methods', reason: 'AMB Grid preserves the current end bound and uses the supported two-bound operation because the installed 6.4.0 component implementation routes its contextual start-bound method to the end-bound setter.' },
