...
export const COMPONENT_API_COVERAGE = [
    ...
    { component: 'range', method: 'setStartBound', status: 'exposed', classification: 'delicate', publicMethod: 'setRangeStartBound', controller: 'range-methods', reason: 'grid.setRangeStartBound(range, start) delegates to the installed component, whose 6.4.0 source calls the internal end-bound setter; the audit records that dependency discrepancy without changing runtime behavior.' },
